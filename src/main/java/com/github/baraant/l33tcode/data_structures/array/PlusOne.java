...
public class PlusOne {
    public int[] plusOne(int[] digits) {
        ...
        return plusOneGradually(digits, digits.length-1);
    }

    private int[] plusOneGradually(int[] digits, int currentDigitIndex) {
        ...
        return plusOneGradually(digits, currentDigitIndex-1);
    }
}
